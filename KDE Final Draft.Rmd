...
mid 20th century,
inference of pdfs
from data was limited to histograms.
Histograms
are of limited usefulness because
<!-- of -->
<!-- "the discrete character of the plot...[and] -->
<!-- that changing the bin width slightly -->
<!-- or...shifting the bins slightly may result in a -->
<!-- figure of a different nature." -->
they very discrete and a small change in bin width or shift in bin location
may result in a plot of a very different nature.
<!-- by their very nature are -->
<!-- unsmooth and as the bin width narrows, become less reliable.  -->
<!-- they are very discrete and a small -->
<!-- change in bin width or a shift in bin location -->
<!-- may result in a plot of a very different nature.  -->
\cite{DekkingIntro} 
<!-- %This was in spite of the admission by Parzen  -->
The lack of research was in spite of
the admission by \cite{parzenOG} of 
...
a probability density, is radially symmetric and unimodal. \cite{DekkingIntro} 
...
and plot.
```{r, normPlot, fig.height=1.1, fig.width=6}
...
which we plot:
```{r, bimodPlot, fig.height=1, fig.width=6}
...
the density is totally concentrated about the data points.
This suggests overfitting
<!-- are -->
<!-- and so is overfitted and thus is unlikely to generalise -->
so this estimate is unlikely to generalise to other examples
